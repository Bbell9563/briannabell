function getInfo() {
  ...
  document.getElementById("info").style = "display: block;padding:20px;"
  document.getElementById("enter-info").style = "display: none;"
  document.getElementById("user").innerHTML = `Name: ${userName}`
  document.getElementById("age").innerHTML = `Age: ${age}`
  document.getElementById("month").innerHTML = `Birth Month: ${birthMonth}`
  document.getElementById("birth-stone").innerHTML = `Birth Stone: ${birthStone}`
  document.getElementById("final").innerHTML = `Final message: "Hello ${userName}. You are ${age} years old. Dang! You are old!Your birthstone is ${birthStone}"`
}
